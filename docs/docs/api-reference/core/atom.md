...
=======
  - `dangerouslyAllowMutability` - In some cases it may be desirable allow mutating of objects stored in atoms that don't represent state changes.  Use this option to override freezing objects in development mode.
